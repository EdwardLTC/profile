...
const CategoryIcons = {
  ...
  Cloud: () => (
    <svg
      ...
      className="w-4 h-4"
    >
      <path d="M20 17.5a4.5 4.5 0 0 0-1-8.88 7 7 0 0 0-13.5 2A4.5 4.5 0 0 0 6.5 21h11a4.5 4.5 0 0 0 2.5-3.5z" />
    </svg>
  ),
  Default: () => (
    <svg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {skills.map((skillGroup, index) => (
            ...
            >
              <h3 className="text-xl font-semibold text-foreground/90 mb-4 flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-2">
                {skillGroup.technologies.map((tech, techIndex) => (
                  <div key={techIndex} className="group relative duration-300">
                    <div
                      className="flex items-center gap-2 px-3 py-2 bg-muted/80 rounded-full border border-border hover:border-emerald-500/50 transition-all duration-300 shadow-md hover:shadow-emerald-500/10"
